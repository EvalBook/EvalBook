 ...
 */
final class Version20200723064005 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_configuration (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, show_logo TINYINT(1) DEFAULT NULL, is_global_config TINYINT(1) NOT NULL, show_help TINYINT(1) DEFAULT NULL, show_title TINYINT(1) DEFAULT NULL, show_search TINYINT(1) DEFAULT NULL, use_schools TINYINT(1) DEFAULT NULL, use_contacts TINYINT(1) DEFAULT NULL, UNIQUE INDEX UNIQ_4B6C0887A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
