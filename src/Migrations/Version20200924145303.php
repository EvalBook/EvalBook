 ...
 */
final class Version20200924145303 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE activity_theme_domain_skill (id INT AUTO_INCREMENT NOT NULL, note_type_id INT NOT NULL, activity_theme_domain_id INT NOT NULL, user_id INT DEFAULT NULL, classroom_id INT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, INDEX IDX_9DD7C5AB44EA4809 (note_type_id), INDEX IDX_9DD7C5AB92B2BDE4 (activity_theme_domain_id), INDEX IDX_9DD7C5ABA76ED395 (user_id), INDEX IDX_9DD7C5AB6278D5A8 (classroom_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE implantation (id INT AUTO_INCREMENT NOT NULL, school_id INT DEFAULT NULL, school_report_theme_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, address VARCHAR(255) NOT NULL, logo VARCHAR(255) DEFAULT NULL, INDEX IDX_16DC605C32A47EE (school_id), INDEX IDX_16DC605C7C73556 (school_report_theme_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE note_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, minimum VARCHAR(255) NOT NULL, maximum VARCHAR(255) NOT NULL, intervals LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
